...
import mdGhostsDark from '../../../../assets/svg/empty-ghosts-md--dark.svg';
import mdGhostsLight from '../../../../assets/svg/empty-ghosts-md--light.svg';
import smGhostsDark from '../../../../assets/svg/empty-ghosts-sm--dark.svg';
import smGhostsLight from '../../../../assets/svg/empty-ghosts-sm--light.svg';
