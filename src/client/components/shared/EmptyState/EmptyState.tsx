...
import mdGhostsDark from 'client/assets/svg/empty-ghosts-md--dark.svg';
import mdGhostsLight from 'client/assets/svg/empty-ghosts-md--light.svg';
import smGhostsDark from 'client/assets/svg/empty-ghosts-sm--dark.svg';
import smGhostsLight from 'client/assets/svg/empty-ghosts-sm--light.svg';
